...
const MovieThemesList = () => {
  ...
  useEffect(() => {
    fetch(
      `https://api.themoviedb.org/3/discover/movie?api_key=87c98f2492b42f48b506b2d48f51461e&page=${page1}&with_keywords=${themeID}&sort_by=${sort}&release_date.lte=${currentYear}&vote_count.gte=5`
    )
      .then((res) => res.json())
      .then((data) => {
